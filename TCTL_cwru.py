...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', type=int, choices=[0, 1, 2, 3], default=0)
    parser.add_argument('--tar', type=int, choices=[0, 1, 2, 3], default=1)
    args = parser.parse_args()

    path_source = f'data_cwru/{args.src}HP'
    path_target = f'data_cwru/{args.tar}HP'
